...
using Trans1istates = std::array<uint, TRANS1I_STATES>;
using Trans1astates = std::array<uint, TRANS1A_STATES>;
using Trans1tstates = std::array<uint, TRANS1T_STATES>;
using Trans2istates = std::array<uint, TRANS2I_STATES>;
using Trans1i1astates = std::array<uint, TRANS1I1A_STATES>;
using Trans1i1tstates = std::array<uint, TRANS1I1T_STATES>;
