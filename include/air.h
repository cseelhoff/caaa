...
AirIndex get_air_from_array(AirIndices* air_array, AirConnIndex air_array_idx);
AirIndices* get_airs_winthin_x_moves(Distance moves, AirIndex src_air);
AirIndices* get_airs_within_x_moves(Distance moves, AirIndex src_air);
...
AirDistances* get_l2a_dist(LandIndex land_idx);
...
void set_l2a_dist(LandIndex src_land, AirIndex dst_air, Distance dist);
