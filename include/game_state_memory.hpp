...
constexpr std::array<const PlayerLandArray*, LAND_UNIT_TYPES_COUNT>
get_idle_land_units(const GameStateMemory& state) {
...
constexpr std::array<const PlayerSeaArray*, SEA_UNIT_TYPES_COUNT - 1>
get_idle_sea_units(const GameStateMemory& state) {
...
// constexpr std::array<const void*, LAND_UNIT_TYPES_COUNT>
// get_active_land_units(const GameStateMemory& state) {
//   return
...
using MaxActiveLandUnits = const std::array<uint, LANDS_COUNT * BOMBER_LAND_STATES>*;
std::array<MaxActiveLandUnits, LAND_UNIT_TYPES_COUNT> get_active_land_units2(const GameStateMemory &state) {
  return std::array<MaxActiveLandUnits, LAND_UNIT_TYPES_COUNT>{
      reinterpret_cast<MaxActiveLandUnits>(&state.active_land_fighters),
      reinterpret_cast<MaxActiveLandUnits>(&state.active_land_bombers),
      reinterpret_cast<MaxActiveLandUnits>(&state.active_land_infantry),
      reinterpret_cast<MaxActiveLandUnits>(&state.active_land_artillery),
      reinterpret_cast<MaxActiveLandUnits>(&state.active_land_tanks),
      reinterpret_cast<MaxActiveLandUnits>(&state.active_land_aaguns)};
}

// constexpr std::array<const void*, SEA_UNIT_TYPES_COUNT>
// get_active_sea_units(const GameStateMemory& state) {
...
using MaxActiveSeaUnits = const std::array<uint, SEAS_COUNT * BOMBER_SEA_STATES>*;
std::array<MaxActiveSeaUnits, SEA_UNIT_TYPES_COUNT> get_active_sea_units2(const GameStateMemory &state) {
  return std::array<MaxActiveSeaUnits, SEA_UNIT_TYPES_COUNT>{
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_fighters),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_transempty),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_trans1i),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_trans1a),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_trans1t),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_trans2i),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_trans1i1a),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_trans1i1t),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_submarines),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_destroyers),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_carriers),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_cruisers),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_battleships),
      reinterpret_cast<MaxActiveSeaUnits>(&state.active_sea_bs_damaged),
