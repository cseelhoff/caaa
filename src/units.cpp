...
const Seanunittypes MAX_MOVE_SEA = {FIGHTER_MOVES_MAX,    TRANSPORT_MOVES_MAX,  TRANSPORT_MOVES_MAX,
...
const Seanunittypes COST_UNIT_SEA = {FIGHTER_COST,
                                     TRANSPORT_COST,
...
const LandUTSeaUT LOAD_UNIT_TYPE = {
    {// FIGHTER
     ...
     // LOAD_ARTILLERY
     {MAX_INT, TRANS_1A, TRANS_1I_1A, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT,
      MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT},
     // LOAD_TANK
...
const Seanunittypes UNMOVED_SEA = {FIGHTER_UNMOVED,     TRANS_EMPTY_UNMOVED, TRANS_1I_UNMOVED,
...
const Landunittypes ORDER_OF_LAND_DEFENDERS = {AA_GUNS, BOMBERS_LAND_AIR, INFANTRY, ARTILLERY,
                                               TANKS,   FIGHTERS};
