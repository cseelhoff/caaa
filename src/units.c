...
const uint8_t COST_UNIT_SEA[COST_UNIT_SEA_COUNT] = {FIGHTER_COST,   TRANSPORT_COST, SUB_COST,
                                                    DESTROYER_COST, CARRIER_COST,   CRUISER_COST,
                                                    BATTLESHIP_COST};
...
const uint8_t LOAD_UNIT_TYPE[LAND_UNIT_TYPES][SEA_UNIT_TYPES] = {
    ...
    {INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY,
     INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY},
    // LOAD_INFANTRY
    {INFINITY, TRANS_1I, TRANS_2I, TRANS_1I_1A, TRANS_1I_1T, INFINITY, INFINITY, INFINITY, INFINITY,
     INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY},
    // LOAD_ARTILLERY
    {INFINITY, TRANS_1A, TRANS_1I_1A, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY,
     INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY},
    // LOAD_TANK
    {INFINITY, TRANS_1T, TRANS_1I_1T, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY,
     INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY},
    // AA-GUN
    {INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY,
     INFINITY, INFINITY, INFINITY, INFINITY, INFINITY, INFINITY}};

const uint8_t UNLOAD_CARGO1[SEA_UNIT_TYPES] = {INFINITY, INFINITY,  INFANTRY, ARTILLERY, TANKS,
                                               INFANTRY, ARTILLERY, TANKS,    INFINITY,  INFINITY,
                                               INFINITY, INFINITY,  INFINITY, INFINITY,  INFINITY};

const uint8_t UNLOAD_CARGO2[SEA_UNIT_TYPES] = {INFINITY, INFINITY, INFINITY, INFINITY, INFINITY,
                                               INFANTRY, INFANTRY, INFANTRY, INFINITY, INFINITY,
                                               INFINITY, INFINITY, INFINITY, INFINITY, INFINITY};
