...
const uint8_t UNIT_WEIGHTS[LAND_UNIT_TYPES_COUNT] = {MAX_UINT8_T,         MAX_UINT8_T,    INFANTRY_WEIGHT,
                                               ARTILLERY_WEIGHT, TANK_WEIGHT, AA_GUN_WEIGHT};

const uint8_t ATTACK_UNIT_LAND[LAND_UNIT_TYPES_COUNT] = {FIGHTER_ATTACK,   BOMBER_ATTACK, INFANTRY_ATTACK,
                                                   ARTILLERY_ATTACK, TANK_ATTACK,   AA_GUN_ATTACK};

const uint8_t DEFENSE_UNIT_LAND[LAND_UNIT_TYPES_COUNT] = {FIGHTER_DEFENSE,  BOMBER_DEFENSE,
                                                    INFANTRY_DEFENSE, ARTILLERY_DEFENSE,
                                                    TANK_DEFENSE,     AA_GUN_DEFENSE};

const uint8_t MAX_MOVE_LAND[LAND_UNIT_TYPES_COUNT] = {FIGHTER_MOVES_MAX,  BOMBER_MOVES_MAX,
                                                INFANTRY_MOVES_MAX, ARTILLERY_MOVES_MAX,
                                                TANK_MOVES_MAX,     AA_GUN_MOVES_MAX};

const uint8_t STATES_MOVE_LAND[LAND_UNIT_TYPES_COUNT] = {FIGHTER_STATES,  BOMBER_LAND_STATES,
                                                   INFANTRY_STATES, ARTILLERY_STATES,
                                                   TANK_STATES,     AA_GUN_STATES};

const uint8_t COST_UNIT_LAND[LAND_UNIT_TYPES_COUNT] = {FIGHTER_COST,   BOMBER_COST, INFANTRY_COST,
...
const uint8_t ATTACK_UNIT_SEA[SEA_UNIT_TYPES_COUNT] = {
...
const uint8_t DEFENSE_UNIT_SEA[SEA_UNIT_TYPES_COUNT] = {
...
const uint8_t MAX_MOVE_SEA[SEA_UNIT_TYPES_COUNT] = {
...
const uint8_t STATES_MOVE_SEA[SEA_UNIT_TYPES_COUNT] = {
...
const uint8_t COST_UNIT_SEA[SEA_UNIT_TYPES_COUNT] = {
...
const uint8_t STATES_STAGING[SEA_UNIT_TYPES_COUNT] = {0,
...
const uint8_t STATES_UNLOADING[SEA_UNIT_TYPES_COUNT] = {0,
...
const uint8_t LOAD_UNIT_TYPE[LAND_UNIT_TYPES_COUNT][SEA_UNIT_TYPES_COUNT] = {
    // FIGHTER
...
const uint8_t UNLOAD_CARGO1[SEA_UNIT_TYPES_COUNT] = {MAX_UINT8_T, MAX_UINT8_T,  INFANTRY, ARTILLERY, TANKS,
                                               INFANTRY, ARTILLERY, TANKS,    MAX_UINT8_T,  MAX_UINT8_T,
                                               MAX_UINT8_T, MAX_UINT8_T,  MAX_UINT8_T, MAX_UINT8_T,  MAX_UINT8_T};

const uint8_t UNLOAD_CARGO2[SEA_UNIT_TYPES_COUNT] = {MAX_UINT8_T, MAX_UINT8_T, MAX_UINT8_T, MAX_UINT8_T, MAX_UINT8_T,
                                               INFANTRY, INFANTRY, INFANTRY, MAX_UINT8_T, MAX_UINT8_T,
                                               MAX_UINT8_T, MAX_UINT8_T, MAX_UINT8_T, MAX_UINT8_T, MAX_UINT8_T};

const uint8_t UNMOVED_SEA[SEA_UNIT_TYPES_COUNT] = {
...
const uint8_t DONE_MOVING_SEA[SEA_UNIT_TYPES_COUNT] = {
