...
const Distance MAX_MOVE_LAND[LAND_UNIT_TYPES_COUNT] = {FIGHTER_MOVES_MAX,  BOMBER_MOVES_MAX,
...
const Distance MAX_MOVE_SEA[SEA_UNIT_TYPES_COUNT] = {
...
const SeaUnitStateCount STATES_MOVE_SEA[SEA_UNIT_TYPES_COUNT] = {
    ...
    TRANS_2I_STATES, TRANS_1I_1A_STATES, TRANS_1I_1T_STATES, SUBMARINE_STATES,        DESTROYER_STATES,
